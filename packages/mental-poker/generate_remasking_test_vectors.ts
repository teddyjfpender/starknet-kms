...
function generateRemaskingTestVector(seed: number[], testIndex: number): RemaskingTestVector {
...
function generateRemaskingTestVectors(count: number = 3): void {
  ...
  console.log(`Generated ${testVectors.length} remasking test vectors in ${outputPath}`)
}
