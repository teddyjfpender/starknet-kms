...
export function remaskWithProof(
  ...
  const proof = proveRemasking(pp, sharedKey, originalMasked, remaskedCard, alpha, nonce)
 ...
 */
export function remaskingProofsEqual(proof1: RemaskingProof, proof2: RemaskingProof): boolean {
  return (
