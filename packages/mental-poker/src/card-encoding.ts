import { G, type Point, randScalar, scalarMultiply } from "@starkms/crypto"
 ...
 */
export function createClassicCard(
  value: Value,
  suite: Suite,
): ClassicPlayingCard {
  return { value, suite }
